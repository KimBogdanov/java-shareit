...
public class BookingController {
    ...
    public ResponseEntity<Object> approvedBooking(@RequestHeader(userIdHeader) Long ownerId,
                                                  @PathVariable Long bookingId,
    ...
    @GetMapping("/owner")
    public ResponseEntity<Object> getBookingsForOwnerItem(@RequestHeader(userIdHeader) Long ownerId,
        ...
        return bookingClient.getBookingsForOwnerItem(ownerId, status, from, size);
    }
}
